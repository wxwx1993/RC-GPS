...
#############plot balance plot
pdf(paste0("balance_cor3.pdf"),width=20,height=8.5)
par(oma = c(4, 1, 1, 1))
par(mfrow=c(1,3),las=1, mgp=c(3, 2, 0))
par(mar=c(5.1, 14.1, 4.1, 2.1))
histcolors = c(rgb(0,0,1,.8), rgb(0,1,0,.8),rgb(1,0,0,.8),rgb(0,0,0,.8))
#histcolors = c(rgb(0,0,0,.6),rgb(0,0,0,.8),rgb(0,0,0,1),rgb(0,0,0,.3))
histtypes=c(5,6,3,1)
histpch=c(0,1,2,5)
plot(abs(init.balance.0)[order.0],c(1,2,3,4,5,6),yaxt="n",xlab="",ylab="",type = "b",xlim=c(0,0.4), col = histcolors[4],main=expression(paste(X["c"]==1," vs ",X["c"]!=1)),lwd=3,cex.axis=3,cex.main=4.5,lty = histtypes[4],pch=histpch[4],cex=2)
lines(abs(subclass.balance.0)[order.0],c(1,2,3,4,5,6), col = histcolors[1],lwd=3,lty = histtypes[1],pch=histpch[1], type="b",cex=2)
lines(abs(IPTW.balance.0)[order.0],c(1,2,3,4,5,6), col = histcolors[2],lwd=3,lty = histtypes[2],pch=histpch[2], type="b",cex=2)
lines(abs(matching.balance.0)[order.0],c(1,2,3,4,5,6), col = histcolors[3],lwd=3,lty = histtypes[3],pch=histpch[3], type="b",cex=2)
axis(2, at=c(1,2,3,4,5,6), labels=c("cf1","cf2","cf3","cf4","cf5","cf6")[order.1],cex.axis=4)
#legend("topright",c("Subclass","IPTW","Matching","Original"),col=histcolors,lwd=c(10,10,10),lty=c(1,1,1),cex=0.8)

plot(abs(init.balance.1)[order.1],c(1,2,3,4,5,6),yaxt="n",xlab="",ylab="",xlim=c(0,0.4), col = histcolors[4],main=expression(paste(X["c"]==2," vs ",X["c"]!=2)),lwd=3,cex.axis=3,cex.main=4.5,lty = histtypes[4],pch=histpch[4], type="b",cex=2)
lines(abs(subclass.balance.1)[order.1],c(1,2,3,4,5,6), col = histcolors[1],lwd=3,lty = histtypes[1],pch=histpch[1], type="b",cex=2)
lines(abs(IPTW.balance.1)[order.1],c(1,2,3,4,5,6), col = histcolors[2],lwd=3,lty = histtypes[2],pch=histpch[2], type="b",cex=2)
lines(abs(matching.balance.1)[order.1],c(1,2,3,4,5,6), col = histcolors[3],lwd=3,lty = histtypes[3],pch=histpch[3], type="b",cex=2)
axis(2, at=c(1,2,3,4,5,6), labels=c("cf1","cf2","cf3","cf4","cf5","cf6")[order.1],cex.axis=4)
#legend("topright",c("Subclass","IPTW","Matching","Original"),col=histcolors,lwd=c(10,10,10),lty=c(1,1,1),cex=0.8)


plot(abs(init.balance.2)[order.2],c(1,2,3,4,5,6),yaxt="n",xlab="",ylab="",xlim=c(0,0.4), col = histcolors[4],main=expression(paste(X["c"]==3," vs ",X["c"]!=3)),lwd=3,cex.axis=3,cex.main=4.5,lty = histtypes[4],pch=histpch[4], type="b",cex=2)
lines(abs(subclass.balance.0)[order.2],c(1,2,3,4,5,6), col = histcolors[1],lwd=3,lty = histtypes[1],pch=histpch[1], type="b",cex=2)
lines(abs(IPTW.balance.2)[order.2],c(1,2,3,4,5,6), col = histcolors[2],lwd=3,lty = histtypes[2],pch=histpch[2], type="b",cex=2)
lines(abs(matching.balance.2)[order.2],c(1,2,3,4,5,6), col = histcolors[3],lwd=3,lty = histtypes[3],pch=histpch[3], type="b",cex=2)
axis(2, at=c(1,2,3,4,5,6), labels=c("cf1","cf2","cf3","cf4","cf5","cf6")[order.2],cex.axis=4)
#legend("topright",c("Subclass","IPTW","Matching","Original"),col=histcolors,lwd=c(10,10,10),lty=c(1,1,1),cex=0.8)
...
legend("bottomleft", c("Subclass","IPTW","Matching","Original"), xpd = TRUE, horiz = TRUE, inset = c(0, 
        0.0), bty = "n", col=histcolors,lwd=c(10,10,10,10), cex = 3.5,lty=histtypes,pch=histpch)
dev.off()
